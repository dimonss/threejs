...
export default function Dmitrii({position, rotation, scale = [1, 1, 1], onLoad}: DmitriiProps) {
    // В Vite с base path '/threejs/' файлы из public доступны по /threejs/dmitrii.gltf
    // В dev-режиме Vite автоматически добавляет base path к файлам из public
    const baseUrl = import.meta.env.BASE_URL || '/'
    const modelPath = `${baseUrl}dmitrii.gltf`.replace(/\/\//g, '/')
